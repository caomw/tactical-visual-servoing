...
# Generated by qmake (2.01a) (Qt 4.5.2) on: Tue Sep 1 14:08:20 2009
...
SOURCES       = main.cpp \
		...
		tracking_algorithms/Optical_Flow/Horn_Schunck/Horn_Schunck.cpp moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		ImageProcessing.o \
		utilities.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/TACTICAL1.0.0/ && $(COPY_FILE) --parents mainwindow.h ImageProcessing.h utilities/utilities.h image_functions/Image_Functions.h tracking_algorithms/SIFT/imgfeatures.h tracking_algorithms/SIFT/kdtree.h tracking_algorithms/SIFT/minpq.h tracking_algorithms/SIFT/sift.h tracking_algorithms/SIFT/utils.h tracking_algorithms/SIFT/xform.h .tmp/TACTICAL1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp ImageProcessing.cpp utilities/utilities.cpp image_functions/Image_Functions.cpp tracking_algorithms/SIFT/imgfeatures.cpp tracking_algorithms/SIFT/kdtree.cpp tracking_algorithms/SIFT/minpq.cpp tracking_algorithms/SIFT/sift.cpp tracking_algorithms/SIFT/utils.cpp tracking_algorithms/SIFT/xform.cpp tracking_algorithms/Optical_Flow/Horn_Schunck/Horn_Schunck.cpp .tmp/TACTICAL1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/TACTICAL1.0.0/ && (cd `dirname .tmp/TACTICAL1.0.0` && $(TAR) TACTICAL1.0.0.tar TACTICAL1.0.0 && $(COMPRESS) TACTICAL1.0.0.tar) && $(MOVE) `dirname .tmp/TACTICAL1.0.0`/TACTICAL1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/TACTICAL1.0.0
...
Horn_Schunck.o: tracking_algorithms/Optical_Flow/Horn_Schunck/Horn_Schunck.cpp 
