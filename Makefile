...
# Generated by qmake (2.01a) (Qt 4.5.2) on: Tue Sep 1 15:54:17 2009
...
LIBS          = $(SUBLIBS)  -L/home/lab/qtsdk-2009.03/qt/lib -L/usr/X11R6/lib -lcv -lcxcore -lhighgui -lcorrespondence -limage -lglog -lgflags -lturingtracking -lgsl -lgslcblas -lSDL -lSDL_image -lQtOpenGL -L/home/lab/qtsdk-2009.03/qt/lib -L/usr/X11R6/lib -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -lQtGui -pthread -lfreetype -lgobject-2.0 -lSM -lICE -pthread -pthread -lXrender -lfontconfig -lXext -lX11 -lQtNetwork -pthread -pthread -lQtCore -lm -pthread -lgthread-2.0 -lrt -lglib-2.0 -ldl -lGLU -lGL -lpthread
AR            = ar cqs
RANLIB        = 
...
SOURCES       = main.cpp \
		...
		tracking_algorithms/Optical_Flow/klt++/writeFeatures.cpp moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		ImageProcessing.o \
		utilities.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/TACTICAL1.0.0/ && $(COPY_FILE) --parents mainwindow.h ImageProcessing.h utilities/utilities.h image_functions/Image_Functions.h tracking_algorithms/SIFT/imgfeatures.h tracking_algorithms/SIFT/kdtree.h tracking_algorithms/SIFT/minpq.h tracking_algorithms/SIFT/sift.h tracking_algorithms/SIFT/utils.h tracking_algorithms/SIFT/xform.h tracking_algorithms/Optical_Flow/Horn_Schunck/Horn_Schunck.h .tmp/TACTICAL1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp ImageProcessing.cpp utilities/utilities.cpp image_functions/Image_Functions.cpp tracking_algorithms/SIFT/imgfeatures.cpp tracking_algorithms/SIFT/kdtree.cpp tracking_algorithms/SIFT/minpq.cpp tracking_algorithms/SIFT/sift.cpp tracking_algorithms/SIFT/utils.cpp tracking_algorithms/SIFT/xform.cpp tracking_algorithms/Optical_Flow/Horn_Schunck/Horn_Schunck.cpp tracking_algorithms/Optical_Flow/klt++/convolve.cpp tracking_algorithms/Optical_Flow/klt++/error.cpp tracking_algorithms/Optical_Flow/klt++/klt.cpp tracking_algorithms/Optical_Flow/klt++/klt_util.cpp tracking_algorithms/Optical_Flow/klt++/pnmio.cpp tracking_algorithms/Optical_Flow/klt++/pyramid.cpp tracking_algorithms/Optical_Flow/klt++/selectGoodFeatures.cpp tracking_algorithms/Optical_Flow/klt++/trackFeatures.cpp tracking_algorithms/Optical_Flow/klt++/writeFeatures.cpp .tmp/TACTICAL1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/TACTICAL1.0.0/ && (cd `dirname .tmp/TACTICAL1.0.0` && $(TAR) TACTICAL1.0.0.tar TACTICAL1.0.0 && $(COMPRESS) TACTICAL1.0.0.tar) && $(MOVE) `dirname .tmp/TACTICAL1.0.0`/TACTICAL1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/TACTICAL1.0.0
