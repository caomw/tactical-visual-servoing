...
# Generated by qmake (2.01a) (Qt 4.7.0) on: Thu May 26 14:30:33 2011
# Project:  TACTICAL.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -spec /usr/share/qt4/mkspecs/linux-g++ CONFIG+=debug -o Makefile TACTICAL.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtNetwork -I/usr/include/qt4/QtGui -I/usr/include/qt4/QtOpenGL -I/usr/include/qt4 -I/usr/local/include/opencv -I/usr/local/include/opencv -Isegmentation -Itracking_algorithms/Correlation/TuringTracking -I/usr/X11R6/include -I. -I.
LINK          = g++
LFLAGS        = 
...
SOURCES       = main.cpp \
		...
		FFTLibrary.cpp \
		VideoDisplay.cpp moc_mainwindow.cpp \
...
Makefile: TACTICAL.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++ CONFIG+=debug -o Makefile TACTICAL.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/TACTICAL1.0.0/ && $(COPY_FILE) --parents mainwindow.h image_functions/Image_Functions.h ImageProcessing.h utilities/utilities.h image_functions/Image_Functions.h SimpleIni.h ConvertUTF.h tracking_algorithms/Optical_Flow/KLT/KLT.h avi/AVILibrary.h segmentation.h FFTLibrary.h VideoDisplay.h .tmp/TACTICAL1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp image_functions/Image_Functions.cpp ImageProcessing.cpp utilities/utilities.cpp ConvertUTF.c tracking_algorithms/Optical_Flow/KLT/KLT.cpp avi/AVILibrary.cpp segmentation/segment.cpp FFTLibrary.cpp VideoDisplay.cpp .tmp/TACTICAL1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/TACTICAL1.0.0/ && (cd `dirname .tmp/TACTICAL1.0.0` && $(TAR) TACTICAL1.0.0.tar TACTICAL1.0.0 && $(COMPRESS) TACTICAL1.0.0.tar) && $(MOVE) `dirname .tmp/TACTICAL1.0.0`/TACTICAL1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/TACTICAL1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_VideoDisplay.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_VideoDisplay.cpp
moc_mainwindow.cpp: VideoDisplay.h \
...
moc_VideoDisplay.cpp: VideoDisplay.h
