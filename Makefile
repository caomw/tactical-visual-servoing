...
# Generated by qmake (2.01a) (Qt 4.5.2) on: Sun Aug 9 12:59:29 2009
...
LIBS          = $(SUBLIBS)  -L/home/lab/qtsdk-2009.03/qt/lib -L/usr/X11R6/lib -lcv -lcxcore -lhighgui -lcorrespondence -limage -lglog -lgflags -lQtOpenGL -L/home/lab/qtsdk-2009.03/qt/lib -L/usr/X11R6/lib -pthread -pthread -pthread -pthread -pthread -pthread -pthread -pthread -lQtGui -pthread -lfreetype -lgobject-2.0 -lSM -lICE -pthread -pthread -lXrender -lfontconfig -lXext -lX11 -lQtNetwork -pthread -pthread -lQtCore -lm -pthread -lgthread-2.0 -lrt -lglib-2.0 -ldl -lGLU -lGL -lpthread
AR            = ar cqs
RANLIB        = 
...
SOURCES       = main.cpp \
		...
		image_functions/Image_Functions.cpp moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		utilities.o \
		Image_Functions.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/TACTICAL1.0.0/ && $(COPY_FILE) --parents mainwindow.h utilities/utilities.h image_functions/Image_Functions.h .tmp/TACTICAL1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp utilities/utilities.cpp image_functions/Image_Functions.cpp .tmp/TACTICAL1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/TACTICAL1.0.0/ && (cd `dirname .tmp/TACTICAL1.0.0` && $(TAR) TACTICAL1.0.0.tar TACTICAL1.0.0 && $(COMPRESS) TACTICAL1.0.0.tar) && $(MOVE) `dirname .tmp/TACTICAL1.0.0`/TACTICAL1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/TACTICAL1.0.0
