...
# Generated by qmake (2.01a) (Qt 4.7.0) on: Fri May 13 09:09:36 2011
...
SOURCES       = main.cpp \
		...
		avi/AVILibrary.cpp \
		segmentation/segment.cpp moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		Image_Functions.o \
		ImageProcessing.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/TACTICAL1.0.0/ && $(COPY_FILE) --parents mainwindow.h image_functions/Image_Functions.h ImageProcessing.h utilities/utilities.h image_functions/Image_Functions.h SimpleIni.h ConvertUTF.h tracking_algorithms/Optical_Flow/KLT/KLT.h avi/AVILibrary.h segmentation.h .tmp/TACTICAL1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp image_functions/Image_Functions.cpp ImageProcessing.cpp utilities/utilities.cpp ConvertUTF.c tracking_algorithms/Optical_Flow/KLT/KLT.cpp avi/AVILibrary.cpp segmentation/segment.cpp .tmp/TACTICAL1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/TACTICAL1.0.0/ && (cd `dirname .tmp/TACTICAL1.0.0` && $(TAR) TACTICAL1.0.0.tar TACTICAL1.0.0 && $(COMPRESS) TACTICAL1.0.0.tar) && $(MOVE) `dirname .tmp/TACTICAL1.0.0`/TACTICAL1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/TACTICAL1.0.0
